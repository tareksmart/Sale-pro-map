...
class SpentChart extends StatefulWidget {
  const SpentChart({super.key});

  @override
  State<SpentChart> createState() => _SpentChartState();
}

class _SpentChartState extends State<SpentChart> {
